...
$("#copytoclipboard").html("<i class='left material-icons'>content_copy</i> Copy URL");
...
M.toast({html: 'Convert Link Successfully!'});
...
M.toast({html: 'The link was successfully copied to the clipboard!'});
});
})
